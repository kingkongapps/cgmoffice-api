...
//
	 ...
	 * @return 해쉬결과 Hex 문자열
	 */
	public String hashMD5HexString(String message) {
...
//	 */
//	public String hashMD5Base64String(String message) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashMD5HexString(String message, String salt) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashMD5Base64String(String message, String salt) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashSHA1HexString(String message) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashSHA1Base64String(String message) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashSHA1HexString(String message, String salt) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashSHA1Base64String(String message, String salt) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashSHA256HexString(String message) {
...
//	 * @return 해쉬결과  Base64 문자열
//	 */
//	public String hashSHA256Base64String(String message) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashSHA256HexString(String message, String salt) {
...
//	 * @return 해쉬결과  Base64 문자열
//	 */
//	public String hashSHA256Base64String(String message, String salt) {
...
//
	 ...
	 * @return 해쉬결과 Hex 문자열
	 */
	public String hashSHA512HexString(String message) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashSHA512Base64String(String message) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashSHA512HexString(String message, String salt) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashSHA512Base64String(String message, String salt) {
...
////	 * @return 해쉬결과 Hex 문자열
////	 */
////	public String hashHmacMD5HexString(String message, String secretKey) {
...
////	 * @return 해쉬결과 Base64 문자열
////	 */
////	public String hashHmacMD5Base64String(String message, String secretKey) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashHmacSHA1HexString(String message, String secretKey) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashHmacSHA1Base64String(String message, String secretKey) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashHmacSHA256HexString(String message, String secretKey) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashHmacSHA256Base64String(String message, String secretKey) {
...
//	 * @return 해쉬결과 Hex 문자열
//	 */
//	public String hashHmacSHA512HexString(String message, String secretKey) {
...
//	 * @return 해쉬결과 Base64 문자열
//	 */
//	public String hashHmacSHA512Base64String(String message, String secretKey) {
...
//	 * @return 인코딩된 문자열
//	 */
//	public String encodeBase64String(String message) {
...
//
	 ...
	 * @param message 원본메시지
	 * @param privateKey 개인키(32bit 문자열)
	 * @return 암호화된 문자열
	 */
	public String encryptAES256(String message, String privateKey) {
		try {
	 ...
	 * @return 복호화된 문자열
	 */
	public String decryptAES256(String message, String privateKey) {
		try {
			String iv = privateKey.substring(0, 16);
			byte[] keyBytes = new byte[16];
			byte[] b = privateKey.getBytes("UTF-8");
...
////	 * @return 암호화된 문자열
////	 */
////	public String encryptDES(String message, String privateKey) {
////		try {
...
////	 * @return 복호화된 문자열
////	 */
////	public String decryptDES(String message, String privateKey) {
////		try {
////			SecretKeySpec skeySpec = new SecretKeySpec(privateKey.getBytes(), "DES");
////			Cipher cipher = Cipher.getInstance("DES/ECB/PKCS5Padding");
...
//	//////////////////////////////////////////////////////////////////////////////////////////Private 메소드
	 ...
	 * 해시결과 바이트 배열
	 */
	private byte[] hash(String message, String algorithm) {
		try {
	 ...
	 * 해시결과 Hex 문자열
	 */
	private String hashHexString(String message, String algorithm) {
...
//	 * 해시결과 Base64 문자열
//	 */
//	private String hashBase64String(String message, String algorithm) {
...
//	 * Hmac 해시결과 바이트 배열
//	 */
//	private byte[] hashHmac(String message, String secretKey, String algorithm) {
//		try {
...
//	 * Hmac 해시결과 Hex 문자열
//	 */
//	private String hashHmacHexString(String message, String secretKey, String algorithm) {
...
//	 */
//	private String hashHmacBase64String(String message, String secretKey, String algorithm) {
...
//	 * salt 적용 해시결과 바이트 배열
//	 */
//	private byte[] hash(String message, String salt, String algorithm) {
//		try {
//			MessageDigest md = MessageDigest.getInstance(algorithm);
//			md.reset();
...
//	 */
//	private String hashHexString(String message, String salt, String algorithm) {
...
//	 */
//	private String hashBase64String(String message, String salt, String algorithm) {
